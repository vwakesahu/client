...
import Members from "../rive-animation";
...
export function TemplateGrid() {
  return (
    ...
    <div className="dark relative flex w-full flex-col rounded-[24px] border border-black/5 bg-neutral-100 p-2 shadow-sm md:flex-col md:items-center md:rounded-[18px] md:p-2">
      <Badge
        variant="outline"
        className="absolute z-50 left-4 top-4 rounded-[14px] border border-black/10 text-base text-neutral-800 md:left-6"
      >
